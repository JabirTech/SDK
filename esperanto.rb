#This module is one of programs I wrote before, so I decided to add it to
# JabirSDK, because it'd be fun, if you can work with Esperanto language
#in your applications :P

module EsperantoLang
	def is_pol?
	 if self[-2] + self[-1] == "oj"
		return true
	 else
